...
var scopes = ['user-read-private', 'user-read-email', "user-read-currently-playing", "user-top-read"];
// route.get('/', (req, res) => {
...
route.get('/spotify/callback', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, error, code, state, data, _b, access_token, refresh_token, expires_in, err_1;
        ...
        switch (_c.label) {
            ...
            case 2:
                ...
                setInterval(function () { return __awaiter(void 0, void 0, void 0, function () {
                    var data_1, access_token_1, err_2;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                console.log('access_token:', access_token_1);
                            ...
                            case 2:
                                err_2 = _a.sent();
                                console.log('problem retrieving refresh thingy: ' + err_2);
                                return [3 /*break*/, 3];
